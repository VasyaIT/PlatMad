...
while True:
    ...
    if game_start:
        ...
        if score > 5000:
            if not is_kit:
                screen.blit(services.kit_surface, (x, 418))
            if x - 50 < hero.sprite.rect.x < x + 10 and 425 < hero.sprite.rect.bottom <= 475 and not is_kit:
                is_kit = True
        ...
        for bullet in spritecollide(hero.sprite, bullets_enemy, True):
            hero.sprite.health -= bullet.damage
